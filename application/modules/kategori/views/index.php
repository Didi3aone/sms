...
<div id="content">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 col-lg-offset-1 text-right">
			<h1>
				<a class="btn btn-primary" href="<?= site_url(); ?>kategori/create" rel="tooltip" title="Add new Category" data-placement="left">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hasinput" style="width:80px">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="username_filter" name="filter[kategori]" class="form-control filter-this" placeholder="Nama Kategori" />
                                                    <div class="input-group-btn"><button type="button" class="clear-filter btn"><i class="fa fa-close"></i></button></div>
                                                </div>
                                            </div>
                                        </th>
                                    ...
                                    <tr>
                                        <th data-hide="phone,tablet">Kategori ID</th>
