							...
							<table id="dataTable" class="table table-striped table-bordered table-hover" width="100%">
                                <thead>
                                        ...
                                        <th class="hasinput">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="name_filter" name="filter[mobile]" class="form-control filter-this" placeholder="Mobile Phone" />
                                    ...
                                    <tr>
                                        ...
                                        <th data-class="expand">Outbox  </th>
