...
<div id="content">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 col-lg-offset-1 text-right">
			<h1>
				<button class="btn btn-primary submit-form" data-form-target="smsc-form" title="Send SMS" rel="tooltip" data-placement="top" >
			...
			<article class="col-sm-12 col-md-12 col-lg-12">
				...
				data-widget-deletebutton="false">
					...
					<div>
						...
						<form class="smart-form" id="smsc-form" action="<?= site_url('sms/process_form_schedule'); ?>" method="post">
							<?php if($id != 0): ?>
							...
							<fieldset>
                                ...
                                <section>
                                    ...
                                    <label class="input">
                                        <input type="text" name="date_val" value="" id="dateTime">
                                    </label>
                                </section>
