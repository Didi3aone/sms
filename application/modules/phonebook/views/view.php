...
<div id="content">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 col-lg-offset-1 text-right">
			<h1>
				<a class="btn btn-warning back-button" href="<?= site_url('phonebook'); ?>" title="Back" rel="tooltip" data-placement="left">
						...
						<form class="smart-form" id="data-form" action="<?= site_url('phonebook/process_form'); ?>" method="post">
							...
							<fieldset>
								<section>
									...
									<label class="input">
										<input type="text" name="name" disabled='disabled' value="<?= $name ?>" placeholder="Name">
									</label>
								</section>
								...
								<section>
									...
									<label class="input">
										<input type="text" name="dobpob" disabled='disabled' value="<?= $dob; ?>" placeholder="Tanggal Lahir">
									</label>
									<!-- <div class="note">
								...
								<section>
									...
									<label class="input">
										<input type="text" name="no" disabled='disabled' value="<?= $no; ?>" placeholder="No telepon">
									</label>
								</section>
								...
								<section>
									...
									<label class="input">
										<input type="text" name="email" disabled='disabled' value="<?= $email; ?>" placeholder="Email">
									</label>
								</section>
								...
								<section>
									...
									<label class="input">
										<input type="text" name="last_ed" disabled='disabled' value="<?= $last; ?>" placeholder="Pendidikan Terakhir">
									</label>
								</section>
								...
								<section>
									...
									<label class="input">
										<input type="text" name="end_ed" disabled='disabled' value="<?= $end; ?>" placeholder="Tahun Tamat Pendidikan">
									</label>
								</section>
								...
								<section>
									...
									<label class="input">
										<input type="text" name="end_tot" disabled='disabled' value="<?= $total; ?>" placeholder="Total Pengalaman Kerja">
									</label>
								</section>
								...
								<section>
									...
									<label class="input">
										<input type="text" name="region_id" value="<?= $region_name; ?>" disabled='disabled'>
									</label>
								...
								<section>
									...
									<label class="input">
										<input type="text" name="kategori" disabled='disabled' value="<?= $kategori_name; ?>">
									</label>
									<!-- <div class="note">OPSIONAL</div> -->
								</section>
								...
								<section>
									...
									<label class="textarea">
										<textarea name="address" rows="6" disabled="disabled"><?= $address ?></textarea>
									</label>
								</section>
								...
								<div class="row">
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_wi" value="<?= $serf_wi; ?>" placeholder="No Sertifikat">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_wi_lev" value="<?= $serf_wi_lev; ?>" placeholder="Level">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_wi_iss" value="<?= $serf_wi_iss; ?>" placeholder="Dikeluarkan Oleh">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' class="datepicker" name="serf_wi_val" value="<?= $serf_wi_val; ?>" placeholder="Tanggal Valid">
										</label>
									</section>
								...
								<div class="row">
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_ut" value="<?= $serf_ut; ?>" placeholder="No Sertifikat">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_ut_lev" value="<?= $serf_ut_lev; ?>" placeholder="Level">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_ut_iss" value="<?= $serf_ut_iss; ?>" placeholder="Dikeluarkan Oleh">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' class="datepicker" name="serf_ut_val" value="<?= $serf_ut_val; ?>" placeholder="Tanggal Valid">
										</label>
									</section>
								...
								<div class="row">
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_mpi" value="<?= $serf_mpi; ?>" placeholder="No Sertifikat">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_mpi_lev" value="<?= $serf_mpi_lev; ?>" placeholder="Level">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_mpi_iss" value="<?= $serf_mpi_iss; ?>" placeholder="Dikeluarkan Oleh">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' class="datepicker" name="serf_mpi_val" value="<?= $serf_mpi_val; ?>" placeholder="Tanggal Valid">
										</label>
									</section>
								...
								<div class="row">
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_pt" value="<?= $serf_pt; ?>" placeholder="No Sertifikat">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_pt_lev" value="<?= $serf_pt_lev; ?>" placeholder="Level">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_pt_iss" value="<?= $serf_pt_iss; ?>" placeholder="Dikeluarkan Oleh">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' class="datepicker" name="serf_pt_val" value="<?= $serf_pt_val; ?>" placeholder="Tanggal Valid">
										</label>
									</section>
								...
								<div class="row">
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_ir" value="<?= $serf_ir; ?>" placeholder="No Sertifikat">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_ir_lev" value="<?= $serf_ir_lev; ?>" placeholder="Level">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' name="serf_ir_iss" value="<?= $serf_ir_iss; ?>" placeholder="Dikeluarkan Oleh">
										</label>
									</section>
									...
									<section class="col col-3">
										...
										<label class="input">
											<input type="text" disabled='disabled' class="datepicker" name="serf_ir_val" value="<?= $serf_ir_val; ?>" placeholder="Tanggal Valid">
										</label>
									</section>
								...
								<div class="row">
									<section class="col col-6">
										<label class="label">File Sertifikat (WELDING INSPECTOR)</label>
										<label class="input">
									...
									<section class="col col-6">
										<label class="label">File Sertifikat (UT)</label>
										<label class="input">
									...
									<section class="col col-6">
										<label class="label">File Sertifikat (MPI)</label>
										<label class="input">
									...
									<section class="col col-6">
										<label class="label">File Sertifikat (PT)</label>
										<label class="input">
									...
									<section class="col col-6">
										<label class="label">File Sertifikat (INT RADIOGRAPHIC)</label>
										<label class="input">
								...
								<p>
									<b>Informasi :</b> <br/>
									&nbsp;&nbsp;&nbsp; Untuk melihat file pdf silahkan<br/>
									&nbsp;&nbsp;&nbsp; Klik lihat file.
								</p>
								<!-- </header>/header -->
							</fieldset>
